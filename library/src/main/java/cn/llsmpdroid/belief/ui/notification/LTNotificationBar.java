 ...
 */
public class LTNotificationBar extends PopupWindow {
    ...
    public LTNotificationBar(final Activity inActivity, String title, final String content, Bitmap icon, Style style) {
        super();
        ...
        final RelativeLayout.LayoutParams contentLayoutParams = new RelativeLayout.LayoutParams(
                ContextUtils.getScreenWidth(context), RelativeLayout.LayoutParams.WRAP_CONTENT);
        ...
        final RelativeLayout.LayoutParams containerParams =
                new RelativeLayout.LayoutParams(ContextUtils.getScreenWidth(context),
            ...
            public void onClick(View view) {
                if (isShowing) {
                    ...
                    if (onNotificationBarTouchListener != null)
                        onNotificationBarTouchListener.onNotificationTouch(LTNotificationBar.this);
                }
            }
        });
        ...
        iconView.setY(CONTAINER_PADDING + ContextUtils.getStatusBarHeight(context));
        ...
        RelativeLayout.LayoutParams titleParams = new RelativeLayout.LayoutParams(
                (ContextUtils.getScreenWidth(context) - titleX - CONTAINER_PADDING), RelativeLayout.LayoutParams.WRAP_CONTENT);
        ...
        final RelativeLayout.LayoutParams bottomLineParams =
                new RelativeLayout.LayoutParams(ContextUtils.getScreenWidth(context), 1);
                        ...
                        startAnimation.setAnimationListener(new Animation.AnimationListener() {
                            ...
                            public void onAnimationStart(Animation animation) {
                                if (notificationStateListener != null && isShowing)
                                    notificationStateListener.onStartShow(context);
                                isShowing = true;
                            }
                            ...
                            public void onAnimationEnd(Animation animation) {
                                if (notificationStateListener != null)
                                    notificationStateListener.onShowComplete(context);
        ...
        this.setWidth(ContextUtils.getScreenWidth(context));// 设置当前控件的宽度为屏幕宽
    ...
    public void hide(boolean animated) {
        ...
        endTranslateAnimation.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationStart(Animation animation) {
                if (notificationStateListener != null)
                    notificationStateListener.onStartHide(context);
            }

            @Override
            public void onAnimationEnd(Animation animation) {
                if (notificationStateListener != null)
                    notificationStateListener.onHideComplete(context);
                dismiss();
            }
    ...
    public interface NotificationTouchListener {
        void onNotificationTouch(LTNotificationBar bar);
    }

    public interface NotificationStateListener {
        // 开始启动
        void onStartShow(Context context);

        // 启动完毕
        void onShowComplete(Context context);

        // 开始隐藏
        void onStartHide(Context context);

        // 隐藏完毕
        void onHideComplete(Context context);
    }
